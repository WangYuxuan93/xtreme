...
def main():
  ...
  parser.add_argument("--max_mention_length", default=16, type=int,
            help="The maximum mention span length of each example.")
  parser.add_argument("--max_entity_length", default=128, type=int,
            help="The maximum candidate entity sequence length in each example.")
